...
public class ConnectMeVcx {
    ...
    public void init() {
        ...
        setVcxLogger("trace", VcxStaticData.uniqueAndroidID, 10000000, new CompletableFuturePromise<>(logFilePath -> {
            ...
            Log.d(TAG, "unique android ID is: " + VcxStaticData.uniqueAndroidID);
...
//    }
    ...
    public String setVcxLogger(String logLevel, String uniqueIdentifier, int MAX_ALLOWED_FILE_BYTES, Promise<String> promise) {
        ...
        VcxStaticData.ENCRYPTED_LOG_FILE_PATH = Environment.getExternalStoragePublicDirectory(
    ...
    public void createConnectionWithInvite(
            String invitationId, String inviteDetails, Promise<Integer> promise) {
   ...
   /* public void getMessages(Promise<String> promise) {
        try{
            UtilsApi.vcxGetMessages();
        }
    }*/
}
